...
(function () {
  ...
  var NAV_CSS = [
    ...
    '[data-theme="dark"] #zitlas-navbar{',
      ...
      'box-shadow:0 8px 32px rgba(0,0,0,.38),0 2px 8px rgba(0,0,0,.22),inset 0 1px 0 rgba(255,255,255,.04);',
    '}',
    /* Light */
    ...
    '#zitlas-navbar .nav-item{',
      ...
      'color:#888888;text-decoration:none;border-radius:16px;',
      'transition:color .2s,background .2s,transform .28s;',
      '-webkit-tap-highlight-color:transparent;',
    '}',
    '[data-theme="light"] #zitlas-navbar .nav-item{color:#666666;}',
    /* Hover */
    '#zitlas-navbar .nav-item:hover{',
      'color:#cccccc;background:rgba(255,255,255,.06);transform:translateY(-2px);',
    '}',
    '[data-theme="light"] #zitlas-navbar .nav-item:hover{',
      'color:#333333;background:rgba(0,0,0,.04);',
    '}',
    /* Active */
    '#zitlas-navbar .nav-item.active{color:#FF8A00;background:rgba(255,138,0,.12);}',
    '#zitlas-navbar .nav-item.active:hover{background:rgba(255,138,0,.18);}',
    ...
    '#zitlas-navbar .nav-item.active .nav-emoji{filter:drop-shadow(0 0 6px rgba(255,138,0,.55));transform:translateY(-1px);}',
    ...
    '#zitlas-navbar .nav-active-dot{',
      ...
      'background:#FF8A00;box-shadow:0 0 7px #FF8A00;',
