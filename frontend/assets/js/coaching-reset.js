...
(function (win) {
  ...
  /* Dismisses every review_requests doc this device currently references
     (the active anchor + anything already merged into expert_plan_reviews)
     so review-sync.js's live listener can never resurrect them. Best
     effort — a write failure here doesn't block the reset; it just means
     review-sync may re-show a stale banner until dismissed some other way. */
